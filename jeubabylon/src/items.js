...
export const itemsByLevel = {
    ...
    4: [
        { row: 1, col: 4, model: piece, scale: 0.3, type: "piece" },       // couloir du haut
    ...
    5: [
        ...
        { row: 6, col: 4, model: piece, scale: 0.3, type: "piece" },   
    ...
    6: [
        ...
        { row: 1, col: 3, model: piece, scale: 0.3, type: "piece" },                              // couloir départ
        { row: 7, col: 8, model: piece, scale: 0.3, type: "piece" },                              // couloir final
    ],
    7: [
        { row: 1, col: 5, model: piece, scale: 0.3, type: "piece" },                              // couloir départ
        ...
        { row: 13, col: 3, model: piece, scale: 0.3, type: "piece" },                             // zone bas gauche
        { row: 15, col: 12, model: cristal, scale: 0.1, type: "cristal" },                        // couloir bas droite
        { row: 18, col: 5, model: piece, scale: 0.3, type: "piece" },                             // couloir tout en bas
    ],
    8: [
        { row: 1, col: 5, model: piece, scale: 0.3, type: "piece" },                              // couloir départ
        ...
        { row: 9, col: 6, model: piece, scale: 0.3, type: "piece" },                              // couloir central
        ...
        { row: 15, col: 9, model: piece, scale: 0.3, type: "piece" },                             // couloir bas central
        { row: 17, col: 10, model: cristal, scale: 0.1, type: "cristal" },                        // couloir final
    ],
    9: [
        { row: 1, col: 8, model: piece, scale: 0.3, type: "piece" },                              // couloir départ haut
        ...
        { row: 9, col: 12, model: piece, scale: 0.3, type: "piece" },                             // zone centrale bas
        ...
        { row: 17, col: 14, model: piece, scale: 0.3, type: "piece" },                            // couloir final avant sortie
        { row: 18, col: 6, model: piece, scale: 0.3, type: "piece" },                             // couloir tout en bas
    ],
};